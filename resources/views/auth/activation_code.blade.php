            ...
            <div class="col-md-4 mx-auto">
                ...
                <form method="POST" action="{{ route('app_activation_code', ['token' => $token]) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                         class="form-control @if (Session::has('danger')) is-invalid

                         @endif" name="activation-code" id="activation-code" value="@if(Session::has('activation_code')) {{ Session::get('activation_code')}}@endif">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <a href=
                            "{{ route('app_activation_account_change_email',['token'=>$token])}}">Change your email address</a>
                        </div>
