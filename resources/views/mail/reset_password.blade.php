<h1>{{ $name}} Please reset your password</h1>
<p>

    We received a request to change password.
    ...
    or by clicking the following link below to reset your password <br>
    <a href="{{route('app_changePassword',['token'=>$activation_token])}}" target="_blank">Reset password</a>
</p>
<p>
    ColobaneOnline security team.
